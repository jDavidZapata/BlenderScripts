...
for i in range(0, count, 1):
    ...
    for j in range(0, count, 1):
        ...
        for k in range(0, count):
            ...
            # Placeholders between curly braces will be replaced by value of k, j, i.
            ...
            mat.diffuse_color = (kprc, jprc, iprc, alph)
            current.data.materials.append(mat)

# Add a sun lamp above the grid.
bpy.ops.object.light_add(type='SUN', radius=1.0, location=(0.0, 0.0, grid * 0.667))

# Add an isometric camera above the grid.
# Rotate 45 degrees on the x-axis, 180 - 45 (135) degrees on the z-axis.
bpy.ops.object.camera_add(location=(grid * 1.414, grid * 1.414, grid * 2.121), rotation=(0.785398, 0.0, 2.35619))
bpy.context.object.data.type = 'ORTHO'
bpy.context.object.data.ortho_scale = grid * 7.0